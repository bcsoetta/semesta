...
<head>
	<meta charset="utf-8" />
	<title>Semesta - Sistem Evaluasi dan Monitoring Bcsh</title>
	<meta name="description" content="Admin, Dashboard, Bootstrap, Bootstrap 4, HTML, JS" />
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimal-ui" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<!-- for ios 7 style, multi-resolution icon of 152x152 -->
	<meta name="apple-mobile-web-app-capable" content="yes">
	<meta name="apple-mobile-web-app-status-barstyle" content="black-translucent">
	<link rel="apple-touch-icon" href="<?php echo base_url('assets/images/location-pin.png'); ?>">
